...
-- AlterTable
ALTER TABLE "expenses" ADD COLUMN     "paidAmount" DECIMAL(15,2) NOT NULL DEFAULT 0,
ADD COLUMN     "balanceDue" DECIMAL(15,2) NOT NULL DEFAULT 0;

-- Update balanceDue for existing expenses
UPDATE "expenses" SET "balanceDue" = "totalAmount" - COALESCE("paidAmount", 0);

-- AlterTable
ALTER TABLE "statement_uploads" ADD COLUMN     "rawExtractedPayload" JSONB,
